					...
					<div class="card mb-4<%=isLastInRow ? " custom-style" : ""%>">
						<div class="card-body">
							...
							<p class="card-text">
								...
								<%=tbean.getClassName()%><br> <strong>Guide
									Name:</strong>
								<%=tbean.getTeamGuide()%><br> <strong>Project
									Problem:</strong> <br>
								<!-- Add more project details here -->
							</p>
							<a class="btn"
								href="/Online-Project-Submisssion/DeleteTeamCtl?id=<%=tbean.getId()%>">
								<i class="fa fa-trash" style="font-size: 24px; color: black;"></i>
							</a>&nbsp; &nbsp; <a class="btn"
								href="/Online-Project-Submisssion/EditTeam?id=<%=tbean.getId()%>">
								<i class="fa fa-edit" style="font-size: 24px; color: black;"></i>
							</a> <a
								href="/Online-Project-Submisssion/AddStudentCtl?id=<%=tbean.getId()%>"
