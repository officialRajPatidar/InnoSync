<%@page import="in.co.online.project.submission.model.TeamModel"%>
...
<body>
	...
	<div id="con" class="container-fluid modal-content h-99 bg-dark" style="">
		...
		<div class="c" align="center" style="color: white">
			<h1 style="margin-top: 10px;">ALL Student</h1>
		...
		<div class="col-xs-12" align="center" style="overflow-x: auto; ">
			...
			<table class="table  table-bordered table-hover"
				style="width: 100%; text-align: center; background: url('\image\imgpro1.jpg');">
				...
				<tbody style="color: white; background-color: black;">
					...
					<tr>
						...
						<td><%=TeamModel.findByStudentId(ub.getId())%></td>
